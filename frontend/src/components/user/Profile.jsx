    ...
    <>
      ...
      <div className="profile-page-container">
        <div className="profile-sidebar">
          <img
            src={`https://github.com/identicons/${userDetails.username}.png`}
            alt="avatar"
          ...
          <div className="follower-info">
            <span>10 followers</span> · <span>3 following</span>
          </div>
        ...
        <div className="profile-main-content">
          <div className="profile-tabs">
            <a href="#" className="profile-tab active">
              <BookIcon /> Overview
            </a>
            <a href="#" className="profile-tab">
              <RepoIcon /> Repositories{" "}
              <span className="repo-count">{userRepos.length}</span>
            </a>
          </div>
